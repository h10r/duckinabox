var Toast = cc.Sprite.extend({
    ...
    ctor:function (x, speed, unit_tag) {
        ...
        var ToastSprite = cc.SpriteFrameCache.getInstance().addSpriteFrames(s_plist_item_toast);

        var pFrame = cc.SpriteFrameCache.getInstance().getSpriteFrame("toast_0000");
