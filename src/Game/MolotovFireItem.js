var MolotovFireItem = cc.Sprite.extend({
    x_start : 0,
    y_start : 0,
    x_end : 0,
    y_end : 0,
    ...
    ctor:function (x,y) {
        ...
        this.item_fire_animation_grow = cc.Animation.create(animFramesGrow, 0.06);
    ...
    startDuckAnimation : function() {
        this.runAction( 
            cc.Sequence.create(
                cc.Animate.create(this.item_fire_animation_grow),
